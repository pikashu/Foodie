...
<%      
	...
	try {
		   ...
		   // Connection con = DriverManager.getConnection(url, "csuser", "your_pwd");
	    	...
	    	String str = "SELECT r.Food, avg(r.Rating) as avg_rating FROM ratings r INNER JOIN restaurants re on r.Restaurant = re.name WHERE re.State = '"
	    		+ state
	    		+ "' group by r.Food order by avg_rating desc";
